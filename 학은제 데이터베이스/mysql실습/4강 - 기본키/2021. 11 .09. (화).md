...
C:\Users\user>cd C:\Program Files\MySQL\MySQL Server 8.0

C:\Program Files\MySQL\MySQL Server 8.0>mysql -u thkim -p
Enter password:
...
mysql> source orders1.sql
ERROR:
Failed to open file 'orders1.sql', error: 2
mysql> source orders1.sql
ERROR:
Failed to open file 'orders1.sql', error: 2
mysql> quit
...
C:\Program Files\MySQL\MySQL Server 8.0>cd C:\Users\user\SQL

C:\Users\user\SQL>myslq -u thkim -p itbank < orders1.sql
'myslq'은(는) 내부 또는 외부 명령, 실행할 수 있는 프로그램, 또는
배치 파일이 아닙니다.

C:\Users\user\SQL>mysql -u thkim -p itbank < orders1.sql;
...
C:\Users\user\SQL>show tables;
'show'은(는) 내부 또는 외부 명령, 실행할 수 있는 프로그램, 또는
배치 파일이 아닙니다.

C:\Users\user\SQL>mtsql -u thkim -p itbank < orders1.sql
...
C:\Users\user\SQL>mysql -u thkim -p itbank < Orders0;
지정된 파일을 찾을 수 없습니다.
...
C:\Users\user\SQL>mysql -u thkim -p itbank < Orders0.sql;
mysql  Ver 8.0.27 for Win64 on x86_64 (MySQL Community Server - GPL)
Copyright (c) 2000, 2021, Oracle and/or its affiliates.
